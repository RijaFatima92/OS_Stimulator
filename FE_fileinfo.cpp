...
/*
 Implement the ls -l command
 Pass any directory path to display the effect of ls -l of the directory
*/
...
int main()
{
   ...
   if (getcwd(cwd, sizeof(cwd)) != NULL) {
    ...
    std::cout << "\n\t\t=-------<< File Exlporer >>-------------=" << std::endl;
    std::cout << "\n\t\t          File Information" << std::endl;  
    std::cout << "\n\t\t=---------------------------------------=" << std::endl;
    std::cout << "\n\t\tShowing Results for : "<< cwd << std::endl;    
    ls_l(cwd);    
